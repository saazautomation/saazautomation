...
export const reviews: Review[] = [
  {
    text: "SAAZ completely transformed our sales pipeline. Their AI voice agent handles 90% of inbound calls and books meetings without any human input. ROI within the first week.",
    initials: "JM",
    name: "JAMES MILLER",
    role: "CEO · TechVentures Inc",
  },
  {
    text: "The trading bot they built has been running clean for 6 months. Disciplined risk, no manual intervention. They understand the markets, not just code.",
    initials: "SR",
    name: "SARAH ROSS",
  ...
  {
    text: "From GHL workflows to a fully custom AI chatbot — SAAZ handled everything seamlessly. Our lead response time dropped from 4 hours to under 4 seconds.",
    initials: "AK",
    name: "ALEX KHAN",
