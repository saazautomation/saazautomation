    ...
    <section id="hero" ref={sectionRef}>
      ...
      <motion.div className="hero-inner" style={{ y: contentY, opacity: contentOpacity }}>
        ...
        >
          ...
          <span className="line-2">INTELLIGENT</span>
          <span className="line-3">SYSTEMS</span>
        </motion.h1>
        <Reveal delay={0.6}>
          <p className="hero-sub">
            Trading bots, AI agents, machine learning models, and agentic workflows that operate
            24/7. Built for founders who want leverage — not more meetings.
          </p>
        </Reveal>
